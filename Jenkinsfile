  ...
  //      }
        stage('[ZAP] Baseline passive-scan') {
            steps {
                ...
                sh '''docker run --name zap --add-host=host.docker.internal:host-gateway -v /path/to/dir/with/passive/scan/yaml:/zap/wrk/:rw -t ghcr.io/zaproxy/zaproxy:stable bash -c \
